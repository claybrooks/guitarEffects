...
//--- Group A pins
	...
	GpioCtrlRegs.GPAMUX1.bit.GPIO1  = 0;		// 0=GPIO  1=EPWM1B     2=ECAP6      3=MFSRB
	GpioCtrlRegs.GPAMUX1.bit.GPIO2  = 0;		// 0=GPIO  1=EPWM2A     2=rsvd       3=rsvd
	GpioCtrlRegs.GPAMUX1.bit.GPIO3  = 0;		// 0=GPIO  1=EPWM2B     2=ECAP5      3=MCLKRB
	...
	GpioCtrlRegs.GPAMUX1.bit.GPIO12 = 0;		// 0=GPIO  1=TZ1        2=CANTXB     3=MDXB
	GpioCtrlRegs.GPAMUX1.bit.GPIO13 = 0;		// 0=GPIO  1=TZ2        2=CANRXB     3=MDRB
	GpioCtrlRegs.GPAMUX1.bit.GPIO14 = 0;		// 0=GPIO  1=TZ3/XHOLD  2=SCITXDB    3=MCLKXB
	GpioCtrlRegs.GPAMUX1.bit.GPIO15 = 0;		// 0=GPIO  1=TZ4/XHOLDA 2=SCIRXDB    3=MFSXB
...
//--- Selected pin configurations
	...
	GpioCtrlRegs.GPBDIR.bit.GPIO34 = 1;			// GPIO34 is an output (connected to LED on F28335 Control Card)
